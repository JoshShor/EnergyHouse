...
public class RechargerNearMeActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationTv = findViewById(R.id.lonlatTextView);
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (location != null) {
            ...
            //Log.i("Latitiude", Double.toString(latitude));
                ...
                if (permissionsRejected.size() > 0) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (shouldShowRequestPermissionRationale(permissionsRejected.get(0))) {
                            new AlertDialog.Builder(RechargerNearMeActivity.this).
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        CameraPosition cameraPosition = new CameraPosition.Builder().target(myPostition).zoom(15.0f).build();
